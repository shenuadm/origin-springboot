package com.cosmos.origin.auth.runner;
...
import com.cosmos.origin.admin.domain.mapper.PermissionMapper;
import com.cosmos.origin.admin.domain.mapper.RoleMapper;
import com.cosmos.origin.admin.domain.mapper.RolePermissionMapper;
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(roleDOS)) {
                ...
                List<RolePermissionRelDO> rolePermissionDOS = rolePermissionMapper.selectByRoleIds(roleIds);
